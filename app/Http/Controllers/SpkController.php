...
class SpkController extends Controller
{
    ...
    {
        $jobOrders = JobOrder::with(['quotations', 'salesOrder'])->select('job_orders.*');
        return DataTables::eloquent($jobOrders)
            ...
            ->addColumn('action', function ($row) {
                ...
                $button .= '<a href="/spk/edit/' . $row->id . '" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit"> <span class="svg-icon svg-icon-md"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                $button .= '<div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left" data-original-title="Quick actions">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                            ...
                            <ul class="navi navi-hover">
                                <li class="navi-item">
                                    <a href="/spk/print/' . $row->id . '" target="_blank" class="navi-link">
    ...
    public function create(Request $request)
    {
        ...
        $salesOrder = SalesOrder::with(['customer', 'quotations.selectedEstimation', 'quotations.customer'])->find($salesOrderId);
    ...
    public function store(Request $request)
    {
        ...
        $jobOrder->number = getRecordNumber(new JobOrder, 'JO');
    ...
    {
        $jobOrder = JobOrder::with(['quotations.customer', 'salesOrder.quotations'])->findOrFail($id);

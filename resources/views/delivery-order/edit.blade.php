                            ...
                            <div class="alert alert-light mb-10">
                                ...
                                <div class="d-flex align-items-center flex-lg-fill mb-4">
                                    ...
                                    <div class="d-flex flex-column text-dark-50">
                                        ...
                                        <span class="font-weight-bolder font-size-h5">
                                            @if($delivery_order->customer !== null)
                                            {{ $delivery_order->customer->name }}
                                            @else
                                            -
                                            @endif
                                        </span>
...
<script>
    let app = new Vue({
        el: '#app',
        data: {
            quotations: JSON.parse(String.raw `{!! $delivery_order->quotations !!}`),
        ...
        methods: {
            ...
            sendData: function() {
                ...
                axios.patch('/delivery-order/{{ $delivery_order->id }}', data)

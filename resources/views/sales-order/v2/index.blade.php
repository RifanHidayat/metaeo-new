...
<div class="card card-custom gutter-b" id="app">
    <div class="card-header flex-wrap py-3">
        ...
        <div class="card-toolbar">
            ...
            <!--end::Dropdown-->
            <!--begin::Button-->
            <a href="/sales-order/create" class="btn btn-primary font-weight-bolder">
...
<script>
    $(function() {
        const salesOrdersTable = $('#sales-order-table').DataTable({
            ...
            ajax: '/datatables/v2/sales-orders',
            columns: [{
                    data: 'number',
        ...
        $('#sales-order-table').on('click', 'tr .btn-delete', function(e) {
            ...
            Swal.fire({
                ...
                showLoaderOnConfirm: true,
                preConfirm: () => {
                    return axios.delete('/sales-order/' + id)
                        .then(function(response) {
                            console.log(response.data);
                        })
                        .catch(function(error) {

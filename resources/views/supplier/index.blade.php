...
<script>
    $(function() {
        const jobOrdersTable = $('#basic-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '/datatables/v2/supplier',
            order: [
                [1, 'desc']
            ],
                ...
                },
                {
                ...
                },
                 {
                 ...
                 
                  {
                    ...
                    name: 'status',
                    render: function(data, type) {
                        return `<span class="text-dark-75 font-weight-bolder font-size-lg text-right">${data=="1"?"Active":"In Active"}</span>`;
                    }
                },
        ...
        $('#purchase-order-table').on('click', 'tr .btn-delete', function(e) {
            e.preventDefault();
            // alert('click');

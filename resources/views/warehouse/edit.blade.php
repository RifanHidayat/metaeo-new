    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold my-1 mr-5">Edit Gudang</h5>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
    ...
    let app = new Vue({
        ...
        methods: {
            ...
            sendData: function() {
                ...
                let vm = this;
                vm.loading = true;
                axios.patch('/warehouse/{{ $warehouse->id }}', {
                        name: vm.name,
                        pic: vm.pic,
                        contact: vm.contact,
                        address: vm.address,
                    ...
                    .then(function(response) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href = '/customer/warehouse/{{ $warehouse->customer_id }}';
                            }
                        })

    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold my-1 mr-5">Manage Pembayaran Pembelian</h5>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="" class="text-muted">Pembayaran Pembelian</a>
                    </li>
                    <li class="breadcrumb-item">
...
<div class="card card-custom gutter-b" id="app">
    <div class="card-header flex-wrap py-3">
        <div class="card-title">
            <h3 class="card-label">List Pembayaran Pembelian
...
<script>
    $(function() {
        const jobOrdersTable = $('#purchase-transaction-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '/datatables/v2/purchase-transactions',
            order: [
                [1, 'desc']
            ],
            columns: [{

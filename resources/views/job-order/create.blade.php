                                                ...
                                                <li class="p-3 bg-light">
                                                    <div class="row">
                                                        <div class="col-lg-8 .col-md-12">
                                                            <input type="text" v-model="category.newItem" class="form-control form-control-sm" placeholder="Masukkan item">
                                                        </div>
                                                        <div class="col-lg-4 .col-md-12">
                                                            <button @click="addFinishingItem(index)" type="button" class="btn btn-sm btn-primary w-100" :class="itemLoading && 'spinner spinner-white spinner-right'">Tambah</button>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="col-lg-6 col-md-12 mt-5 mb-10">
                                            ...
                                            <ul class="p-0 m-0" style="list-style: none;">
                                                <li class="p-3 bg-light">
                                                    <div class="row">
                                                        <div class="col-lg-8 .col-md-12">
                                                            <input type="text" v-model="newCategory" class="form-control" placeholder="Masukkan kategori">
                                                        </div>
                                                        <div class="col-lg-4 .col-md-12">
                                                            <button type="button" @click="addFinishingItemCategory" class="btn btn-success w-100" :class="itemCategoryLoading && 'spinner spinner-white spinner-right'">Tambah</button>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
...
<script>
    let app = new Vue({
        ...
        methods: {
            ...
            addFinishingItem: function(categoryIndex) {
                let vm = this;
                vm.itemLoading = true;

                const category = vm.finishingItemCategories[categoryIndex];

                const data = {
                    name: category.newItem,
                    finishing_item_category_id: category.id,
                }

                axios.post('/finishing-item', data)
                    .then(function(response) {
                        vm.itemLoading = false;
                        category.finishing_items.push(response.data.data)
                        // console.log(response);
                    })
                    .catch(function(error) {
                        vm.itemLoading = false;
            ...
            addFinishingItemCategory: function() {
                let vm = this;
                vm.itemCategoryLoading = true;

                const data = {
                    name: vm.newCategory,
                }

                axios.post('/finishing-item-category', data)
                    .then(function(response) {
                        vm.itemCategoryLoading = false;
                        vm.finishingItemCategories.push(response.data.data);
                        // console.log(response);
                    })
                    .catch(function(error) {
                        vm.itemCategoryLoading = false;

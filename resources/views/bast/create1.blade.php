                                                ...
                                                <div class="col-md-12 col-lg-4">
                                                 ...
                                                 <div class="col-md-12 col-lg-4">
                                                    <table class="table">
                                                        <tr>
                                                            <td>Nomor PO</td>
                                                            <td><strong>@{{ selectedData.data.po_quotation.number }}</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Tangagl PO</td>
                                                            <td><strong>@{{ selectedData.data.po_quotation.date}}</strong></td>
                                                        </tr>
...
<script>
    $(function() {
        ...
        $('#quotation-table tbody').on('click', '.btn-choose', function() {
            ...
            console.log(data.pic_event.name);
            console.log(data)

  ...
  <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
    ...
    <div class="d-flex align-items-center flex-wrap mr-1">
      ...
      <div class="d-flex align-items-baseline flex-wrap mr-5">
        <!--begin::Page Title-->
        <h5 class="text-dark font-weight-bold my-1 mr-5">Edit PIC Event</h5>
        <!--end::Page Title-->
        <!--begin::Breadcrumb-->
...
<script>
  ...
  let app = new Vue({
    ...
    data: {
      name: '{{ $picEvent->name }}',
      phone: '{{ $picEvent->phone }}',
      position: '{{ $picEvent->position }}',
      email: '{{ $picEvent->email }}',
      customerId: '{{ $picEvent->customer_id }}',
    ...
    methods: {
      ...
      sendData: function() {
        ...
        let vm = this;
        vm.loading = true;
        axios.patch('/pic-event/{{ $picEvent->id }}', {
            name: this.name,
            phone: this.phone,
            email: this.email,

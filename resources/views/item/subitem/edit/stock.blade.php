      ...
      <form class="form" autocomplete="off" @submit.prevent="submitForm">
        <div class="card-body">
            ...
            <div class="col-lg-12">
              ...
              <input v-model="unitQuantity" type="text" class="form-control" placeholder="Enter subitem's unit quantity" required>
           ...
           <input v-model="unitFrequency" type="text" class="form-control" placeholder="Enter subitem's unit frequency" required>
...
<script>
  ...
  let app = new Vue({
    el: '#app',
    data: {
       unitQuantity: '{{$subitem->unit_quantity}}',
      unitFrequency: '{{$subitem->unit_frequency}}',
      isStock:1,
    ...
    methods: {
      ...
      sendData: function() {
        ...
        let vm = this;
        vm.loading = true;
        axios.patch('/quotation-item/{{$item->id}}/subitem/{{$subitem->id}}', {
          ...
          .then(function(response) {
            ...
            Swal.fire({
              ...
              if (result.isConfirmed) {
                window.location.href = '/quotaion-item/{{$item->id}}/subitem';
              }
            })

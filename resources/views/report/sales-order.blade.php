    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold my-1 mr-5">Laporan Sales Order</h5>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
    ...
    <div class="card card-custom gutter-b" id="app">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a :href="'/report/sales-order/sheet' + generatedRequest" target="_blank" class="btn btn-light-success font-weight-bold mr-2">Export As .xlsx</a>
    ...
    let app = new Vue({
        ...
        data: {
            ...
            filter: {
                ...
                columnSelections: ['number', 'date', 'customer', 'po_number', 'po_date', 'quotations'],
                status: '',
                customer: '',
                sortBy: '',
                sortIn: 'asc',
...
<script>
    $(function() {
        ...
        let dataTableColumns = function(columnSelections = []) {
            return [{
                ...
                },
                {
                    ...
                    visible: defineColumnVisible(columnSelections, 'po_number'),
                },
                {
                    data: 'po_date',
                    ...
                    visible: defineColumnVisible(columnSelections, 'po_date'),
                },
                {
        ...
        let salesOrdersTable = $('#sales-order-table').DataTable({
            processing: true,
            serverSide: true,
            destroy: true,
            ajax: '/datatables/reports/sales-orders' + urlRequest(),
            order: [
                [2, 'desc']
            ],

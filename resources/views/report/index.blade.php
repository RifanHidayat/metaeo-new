...
<!-- <div class="card card-custom gutter-b" id="app">
    <div class="card-header flex-wrap py-3">
        <div class="card-title">
            <h3 class="card-label">List Laporan</h3>
        </div>
...
<div class="row">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
        ...
        <div class="card card-custom gutter-b card-stretch">
            <a href="/report/estimation">
                <div class="card-body pt-15">
                    <div class="d-flex flex-column align-items-center">
                        <!--begin: Icon-->
                        <span class="svg-icon svg-icon-primary svg-icon-8x">
                            <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Shopping/Calculator.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <!--end: Icon-->
                        <!--begin: Tite-->
                        <h4 class="text-dark-75 mt-5">Estimasi</h4>
                        <!--end: Tite-->
                    </div>
                </div>
            </a>
            ...
            <a href="">
                <div class="card-body pt-15">
                    <div class="d-flex flex-column align-items-center">
                        <!--begin: Icon-->
                        <span class="svg-icon svg-icon-primary svg-icon-8x">
                            <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Communication/Chat4.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24" />
                        ...
                        <!--end: Icon-->
                        <!--begin: Tite-->
                        <h4 class="text-dark-75 mt-5">Quotation</h4>
                        <!--end: Tite-->
                    </div>
                </div>
            </a>
            ...
            <a href="">
                <div class="card-body pt-15">
                    <div class="d-flex flex-column align-items-center">
                        <!--begin: Icon-->
                        <span class="svg-icon svg-icon-primary svg-icon-8x">
                            <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Shopping/Sale1.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24" />
                        ...
                        <!--end: Icon-->
                        <!--begin: Tite-->
                        <h4 class="text-dark-75 mt-5">Sales Order</h4>
                        <!--end: Tite-->
                    </div>
                </div>
            </a>
            ...
            <a href="">
                <div class="card-body pt-15">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <!--end: Icon-->
                        <!--begin: Tite-->
                        <h4 class="text-dark-75 mt-5">SPK</h4>
                        <!--end: Tite-->
                    </div>
                </div>
            </a>
            ...
            <a href="">
                <div class="card-body pt-15">
                    <div class="d-flex flex-column align-items-center">
                        <!--begin: Icon-->
                        <span class="svg-icon svg-icon-primary svg-icon-8x">
                            <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Communication/Sending.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24" />
                        ...
                        <!--end: Icon-->
                        <!--begin: Tite-->
                        <h4 class="text-dark-75 mt-5">Delivery Order</h4>
                        <!--end: Tite-->
                    </div>
                </div>
            </a>
            ...
            <a href="">
                <div class="card-body pt-15">
                    <div class="d-flex flex-column align-items-center">
                        <!--begin: Icon-->
                        <span class="svg-icon svg-icon-primary svg-icon-8x">
                            <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Files/File-done.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <polygon points="0 0 24 0 24 24 0 24" />
                        ...
                        <!--end: Icon-->
                        <!--begin: Tite-->
                        <h4 class="text-dark-75 mt-5">Faktur</h4>
                        <!--end: Tite-->
                    </div>
                </div>
            </a>
            ...
            <a href="">
                <div class="card-body pt-15">
                    <div class="d-flex flex-column align-items-center">
                        <!--begin: Icon-->
                        <span class="svg-icon svg-icon-primary svg-icon-8x">
                            <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Media/Repeat.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24" />
                        ...
                        <!--end: Icon-->
                        <!--begin: Tite-->
                        <h4 class="text-dark-75 mt-5">Transaksi</h4>
                        <!--end: Tite-->
                    </div>
                </div>
            </a>

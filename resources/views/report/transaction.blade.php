    ...
    <div class="card card-custom gutter-b" id="app">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a :href="'/report/transaction/sheet' + generatedRequest" target="_blank" class="btn btn-light-success font-weight-bold mr-2">Export As .xlsx</a>
    ...
    let app = new Vue({
        ...
        data: {
            ...
            filter: {
                ...
                columnSelections: ['number', 'date', 'customer', 'account_name', 'invoices', 'total'],
                // tes: function() {
    ...
    $(function() {
        ...
        let dataTableColumns = function(columnSelections = []) {
            return [{
                ...
                {
                    data: 'account_name',
                    name: 'transactions.account_name',
                    render: function(data, type) {
                        return `<span class="text-primary font-weight-bolder font-size-lg">${data}</span>`;
                    },
                    visible: defineColumnVisible(columnSelections, 'account_name')
                },
                {
                    data: 'invoice_number',
                    ...
                    // },
                    visible: defineColumnVisible(columnSelections, 'invoices')
                },
                {
                    data: 'total',
        ...
        let transactionTable = $('#transaction-table').DataTable({
            ...
            serverSide: true,
            destroy: true,
            ajax: '/datatables/reports/transactions' + urlRequest(),
            order: [
                [2, 'desc']
            ],

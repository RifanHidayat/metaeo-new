    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold my-1 mr-5">Laporan Estimasi</h5>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="" class="text-muted">Estimasi</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div class="card card-custom gutter-b" id="app">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a :href="'/report/estimation/sheet' + generatedRequest" target="_blank" class="btn btn-light-success font-weight-bold mr-2">Export As .xlsx</a>
    ...
    let app = new Vue({
        ...
        data: {
            filter: {
                ...
                columnSelections: ['number', 'date', 'customer', 'work', 'quantity', 'production', 'hpp', 'hpp_per_unit', 'price_per_unit', 'margin', 'total_price', 'ppn', 'pph', 'total_bill', 'delivery_date', 'status'],
                status: '',
                customer: '',
                sortBy: '',
                sortIn: 'asc',

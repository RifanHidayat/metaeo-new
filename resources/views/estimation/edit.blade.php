    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold my-1 mr-5">Edit Estimasi</h5>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="" class="text-muted">{{ $estimation->number }}</a>
                    </li>
                    <li class="breadcrumb-item">
                                ...
                                <div class="card card-custom gutter-b card-stretch">
                                    <div class="card-body">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <!--end: Icon-->
                                            <!--begin: Tite-->
                                            <a href="{{ $estimation->file ? Storage::disk('s3')->url($estimation->file) : '/media/svg/files/jpg.svg' }}" target="_blank" class=" mt-5">
...
<script>
    ...
    let app = new Vue({
        ...
        data: {
            ...
            customerPpn: '{{ $estimation->picPo->customer->with_ppn }}',
            customerPph: '{{ $estimation->picPo->customer->with_pph }}',
            picId: '{{ $estimation->picPo->id }}',
            picEmail: '{{ $estimation->picPo->email }}',
            work: '{{ $estimation->work }}',
            totalQuantity: '{{ $estimation->quantity }}',
            deliveryDate: '{{ $estimation->delivery_date }}',
            sellPricePerUnit: '{{ $estimation->price_per_unit }}',
            // ppn: 0,
            // pph: 0,
            // totalDebt: 0,
            ...
            digitalItems: JSON.parse('{!! json_encode($estimation->digital_items) !!}'),
            // digitalItems: [{
            //   item: '',
            //   paper: '',
            //   printingType: 'BBL',
            ...
            //     text: 'Choose PIC PO'
            // }],
            picPosOptions: JSON.parse('{!! $picPos !!}'),
            picLoading: false,
            loading: false,
        },
        mounted() {
            // this.onChangeCustomer(this.customerId, this.picId);
            if (this.offsetItems.length > 0) {
                // console.log(this.offsetItems.length);
                this.calculateOffsetGrandTotal();
            }
            if (this.digitalItems.length > 0) {
                // console.log(this.offsetItems.length);
        ...
        methods: {
            ...
            sendData: function() {
                ...
                axios.post('/estimation/{{ $estimation->id }}', formData)
            ...
            onChangeCustomer: function(id, initPicId = null) {
                //   console.log('changed');

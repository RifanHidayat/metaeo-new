...
<body>
    ...
    <div class="content">
        <div class="content-left">
            ...
            <div style="padding-left: 10px;">
                <span style="text-transform: capitalize; display: block; margin: 3px 0;"><strong><?= $cpo->customer->name ?></strong></span>
                <p style="margin: 0;">{{ $cpo->customer->address }}</p>
            </div>
        </div>
    ...
    <table>
        ...
        <tbody>
            ...
            @if($cpo->ppn == 1)
            <tr>
                <td>PPN {{ $cpo->ppn_value }}%</td>
                <td class="text-right">Rp {{ rupiahFormat($cpo->ppn_amount) }}</td>
            </tr>
            @endif
            @if($cpo->pph23 == 1)
            <tr>
                <td>PPh 23 {{ $cpo->pph23_value }}%</td>
                <td class="text-right">Rp {{ rupiahFormat($cpo->pph23_amount) }}</td>
            </tr>
            @endif
            <tr>
                <td>Total</td>
                <td class="text-right">Rp {{ rupiahFormat($cpo->total) }}</td>
            </tr>
        </tbody>
    </table>
    <!-- <div>

    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold my-1 mr-5">Manage Pesanan Pembelian</h5>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
...
<div class="card card-custom gutter-b" id="app">
    <div class="card-header flex-wrap py-3">
        <div class="card-title">
            <h3 class="card-label">List Purchase Order
        ...
        <div class="card-toolbar">
            ...
            <!--end::Dropdown-->
            <!--begin::Button-->
            <a href="/purchase-order/create" class="btn btn-primary font-weight-bolder">
        ...
        methods: {
            deleteRecord: function(id) {
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return axios.delete('/job-order/' + id)
...
<script>
    $(function() {
        const jobOrdersTable = $('#purchase-order-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '/datatables/v2/purchase-orders',
            order: [
                [1, 'desc']
            ],
            columns: [

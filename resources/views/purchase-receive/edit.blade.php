                                            ...
                                            <div class="col-lg-3">
                                                <div class="border">
                                                    ...
                                                    <div class="p-3">
                                                        ...
                                                        <p class="text-right font-size-h4">@{{ toCurrencyFormat(totalReceivedQuantity) }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="border">
                                                    ...
                                                    <div class="p-3">
                                                        ...
                                                        <span class="text-right font-size-h10">PPN 11% :@{{ toCurrencyFormat(pphAmount) }}</span><br>
...
<script>
    let app = new Vue({
        ...
        data: {
            ...
            supplier: '',
            number: '',
            date: '{{$purchase_receive->date}}',
            shipper: '{{$purchase_receive->shipper}}',
            recipient: '{{$purchase_receive->recipient}}',
            deliveryAddress: '',
            deliveryDate: '',
            shipment: '',
            paymentTerm: 'net_7',
            sendNumber:'{{$purchase_receive->send_number}}',
            fob: '',
            description: '{{$purchase_receive->description}}',
            selectedGoods: JSON.parse(String.raw `{!! json_encode($selected_goods) !!}`),
            checkedGoodsIds: [],
            invoiceDate:'{{$purchase_receive->invoice_date}}',
            invoiceNumber:'{{$purchase_receive->invoice_number}}',
        ...
        methods: {
            ...
            sendData: function() {
                ...
                let vm = this;
                vm.loading = true;
                axios.patch('/purchase-receive/'+this.id, {
        ...
        computed: {
            ...
            totalReceivedQuantity: function() {
                const receivedQuantity = this.selectedGoods.map(goods => Number(goods.received_quantity)).reduce((acc, cur) => {
                    return acc + cur;
                }, 0);

                return receivedQuantity;
            },
            totalWillBeReceived: function() {
                const total = this.checkedGoods.map(goods => Number(goods.receive_quantity)).reduce((acc, cur) => {
                    return acc + cur;
                }, 0);

                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <em v-if="ups.length === 0"><i class="flaticon2-warning text-warning"></i> Pilih Estimasi</em>
                        </div>
                        <div class="col-lg-6">
    ...
    const noteEditor = tinymce.init({
        ...
        setup: function(editor) {
            editor.on('init', function(e) {
                editor.setContent(
                    '<p>- Pekerjaan dimulai setelah keseluruhan materi cetak dan persetujuan telah kami terima</p>' +
                    '<p>- Harga tidak mengikat & Belum termasuk PPN 10 %</p>'
                );
            });
        }
        // max_height: 100,
